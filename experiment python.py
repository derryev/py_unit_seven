...
def determine_dropdowns():
    ...
    menu_instructions.grid(row=6,column=2,columnspan=1)
...
# dropdown = tk.OptionMenu(root, selected_boulder, "Vintro", "V0", "V1", "V2", "V3", "V4", "V5", "V6",      #I learned how to make a dropdown menu from https://www.tutorialsfreak.com/python-tutorial/drop-down-menus-in-python-tkinter, but I did the grid myself.
                         #"V7", "V8", "V9", "V10")
